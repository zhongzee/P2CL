    ...
    while global_step < args.train.min_step:
        ...
        for i, ((im_source, label_source), (im_target, label_target)) in enumerate(iters):
            ...
            with OptimizerManager(
                ...
                # + args.train.clip_weight * feature_alignment_loss
                # loss = ce + args.train.adv_loss_tradeoff * adv_loss + args.train.entropy_tradeoff * entropy + \
...
if __name__ == "__main__":
    ...
    def objective(trial):
        ...
        hyperparameters = {
            'adv_loss_tradeoff': trial.suggest_float('adv_loss_tradeoff', 0.5, 2.0),
            'ce_aug_tradeoff': trial.suggest_float('ce_aug_tradeoff', 0.5, 2.0),
            'lr': trial.suggest_float('lr', 0.0001, 0.01),
            'entropy_tradeoff': trial.suggest_float('entropy_tradeoff', 0.2, 2.0),
            'min_step': 1000,
            'adv_loss_aug_tradeoff': trial.suggest_float('adv_loss_aug_tradeoff', 0.2, 2.0),
            'Source_Discri_weight': trial.suggest_float('Source_Discri_weight', 0.2, 2.0),
            'clip_weight': trial.suggest_float('clip_weight', 0.5, 5.0)
        }
